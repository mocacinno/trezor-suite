        ...
        <Wrapper>
            <Header>
                <Prompt model={majorVersion}>
                    <Translation
                        message={l10nMessages.TR_CONFIRM_TRANSACTION_ON}
                        values={{ deviceLabel: device.label }}
                    />
                </Prompt>
                <P>
                    <Translation message={l10nMessages.TR_DETAILS_ARE_SHOWN_ON} />
                </P>
            </Header>
            <Content>
                <Section>
                    <Heading>
                        <Translation message={l10nMessages.TR_SEND_LABEL} />
                    </Heading>
                    {outputs.map(output => (
                        <OutputWrapper key={output.id}>
                            ...
                            <Row>
                                <Label>
                                    <Translation message={l10nMessages.TR_TO_LABEL} />
                                </Label>
                ...
                <Section>
                    <Heading>
                        <Translation message={l10nMessages.TR_FEE_LABEL} />
                    </Heading>
                    <Row>
                        <Value>
                ...
                {account.networkType === 'bitcoin' && (
                    <Section>
                        <Heading>
                            <Translation message={l10nMessages.TR_ESTIMATED_TIME} />
                        </Heading>
                        <Row>
                            <Value>
                                {formatDuration(

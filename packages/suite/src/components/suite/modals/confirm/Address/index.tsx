        ...
        <Wrapper>
            <Header>
                <Prompt model={majorVersion}>
                    <Translation message={l10nMessages.TR_CONFIRM_ADDRESS_ON_TREZOR} />
                </Prompt>
                <P>
                    <Translation message={l10nMessages.TR_PLEASE_COMPARE_YOUR_ADDRESS} />
                </P>
            </Header>
            <Content>
                ...
                <Label>
                    {network.symbol}
                    <Translation
                        message={l10nCommonMessages.TR_ACCOUNT_HASH}

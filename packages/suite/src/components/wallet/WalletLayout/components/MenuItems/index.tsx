        ...
        <>
            {showClone && (
                ...
                >
                    ...
                    <Label>
                        <Translation message={l10nMessages.TR_ADD_HIDDEN_WALLET} />
                    </Label>
                </MenuItem>
            )}
            <Divider />
            <MenuItem>
                ...
                <Label>
                    <Translation message={l10nCommonMessages.TR_HIDE_BALANCE} />
                </Label>
                <SwitchWrapper
                    onClick={event => {
            ...
            <MenuItem onClick={() => props.goto('wallet-settings')}>
                ...
                <Label>
                    <Translation message={l10nCommonMessages.TR_APPLICATION_SETTINGS} />
                </Label>
            </MenuItem>
        </>
    );
